Feature: Create a job
  ...
  Scenario: Return an error 400 when the environment is not available in the project
    ...
    And with this body answer, in json, '{"error":true, "message":"teknoo.paas.error.job.not_validated", "extra":"teknoo.paas.error.job.not_validated"}'
  ...
  Scenario: Return an error 501 when the project is not fully filled in the PaaS
    ...
    And with this body answer, in json, '{"error":true,"message":"teknoo.paas.error.project.not_executable", "extra":"teknoo.paas.error.project.not_executable"}'
