...
/**
 * Object writer in charge of object `Teknoo\East\Paas\Object\Cluster`.
 ...
 * @author      Richard Déloge <richard@teknoo.software>
 *
 * @implements WriterInterface<Cluster>
 */
class ClusterWriter implements WriterInterface
{
    /**
     * @use PersistTrait<Cluster>
     */
    use PersistTrait;
