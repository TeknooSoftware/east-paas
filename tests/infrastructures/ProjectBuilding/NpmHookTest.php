...
class NpmHookTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(NpmHook::class, $this->buildHook()->setPath('/foo'));
    }
    ...
    public function testSetOptionsWithPipe(): void
    {
        ...
        $this->assertInstanceOf(NpmHook::class, $this->buildHook()->setOptions(['install || rm -r /'], $promise));
    }
    ...
    public function testSetOptionsWithNonSaclarArguments(): void
    {
        ...
        $this->assertInstanceOf(NpmHook::class, $this->buildHook()->setOptions(['action' => 'install', 'arguments' => [['foo']]], $promise));
    }
    ...
    public function testSetOptionsWithPipeInArguments(): void
    {
        ...
        $this->assertInstanceOf(NpmHook::class, $this->buildHook()->setOptions(['action' => 'install', 'arguments' => ['--no-dev || rm -r /']], $promise));
    }
    ...
    public function testSetOptionsWithForbiddenCommand(): void
    {
        ...
        $this->assertInstanceOf(NpmHook::class, $this->buildHook()->setOptions(['global', 'install'], $promise));
    }
    ...
    public function testSetOptions(): void
    {
        ...
        $this->assertInstanceOf(NpmHook::class, $this->buildHook()->setOptions(['install'], $promise));
    }
    ...
    public function testSetOptionsWithAction(): void
    {
        ...
        $this->assertInstanceOf(NpmHook::class, $this->buildHook()->setOptions(['action' => 'install'], $promise));
    }
    ...
    public function testSetOptionsWithActionAndArguments(): void
    {
        ...
        $this->assertInstanceOf(NpmHook::class, $this->buildHook()->setOptions(['action' => 'install', 'arguments' => ['dry-run', 'foo']], $promise));
    }

    public function testSetOptionsWithActionAndForbiddenArguments(): void
    {
        $promise = $this->createMock(PromiseInterface::class);
        $promise->expects($this->never())->method('success');
        $promise->expects($this->once())->method('fail');

        $this->assertInstanceOf(NpmHook::class, $this->buildHook()->setOptions(['action' => 'install', 'arguments' => ['&']], $promise));
    }
    ...
    public function testRunProcessSuccess(): void
    {
        ...
        $this->assertInstanceOf(NpmHook::class, $this->buildHook(
            true,
            [
                    'install',
                    '--dry-run',
    ...
    public function testRunProcessFail(): void
    {
        ...
        $this->assertInstanceOf(NpmHook::class, $this->buildHook(false)->run($promise));
    }
}
