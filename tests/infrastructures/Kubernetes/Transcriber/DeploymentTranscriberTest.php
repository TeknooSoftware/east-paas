...
class DeploymentTranscriberTest extends TestCase
{
    ...
    public function testRunWithKubernetes136(): void
    {
        ...
        $transcriber = new DeploymentTranscriber('paas.east.teknoo.net', '1.36');
        ...
        $this->assertArrayHasKey('hostUsers', $capturedSpec);
    ...
    public function testRunWithKubernetes135Explicit(): void
    {
        ...
        $transcriber = new DeploymentTranscriber('paas.east.teknoo.net', '1.35');
        $this->assertInstanceOf(DeploymentTranscriber::class, $transcriber->transcribe(
            compiledDeployment: $cd,
            client: $kubeClient,
            promise: $promise,
    ...
    public function testRunWithKubernetes130Explicit(): void
    {
        ...
        $transcriber = new DeploymentTranscriber('paas.east.teknoo.net', '1.30');
        $this->assertInstanceOf(DeploymentTranscriber::class, $transcriber->transcribe(
            compiledDeployment: $cd,
            client: $kubeClient,
            promise: $promise,
        ...
        $this->assertSame('repository.teknoo.run/foo1', $capturedSpec['initContainers'][0]['image']);
        $this->assertSame(
            [
                'name' => 'foo1-volume',
                'emptyDir' => [],
